  ...
  public static void main(String[] args) {
    ...
    */
    ...
    try{
      ...
      NamingEnumeration<NameClassPair> lst=ctx.list(myName);
      while(lst.hasMore()){
        NameClassPair nc = lst.next();
        System.out.println(nc);
      }
      
      System.out.println("\nContinutul catalogului "+myName+" este:\n"); 
      NamingEnumeration<Binding> lst1 = ctx.listBindings(myName);
      while (lst1.hasMore()) {
        Binding bd = lst1.next();
