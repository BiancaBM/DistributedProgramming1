...
public class AgendaE{
  ...
  public static void main(String[] args){
    ...
    try {
      switch(dbms){
        case "derby":
          Class.forName(jdbcDriverDerby).getDeclaredConstructor().newInstance();
          jdbcURI=jdbcURIDerby;
          break;
        case "mysql":
          Class.forName(jdbcDriverMysql).getDeclaredConstructor().newInstance();
          jdbcURI=jdbcURIMysql;
          break;
        case "hsqldb":
          Class.forName(jdbcDriverHsqldb).getDeclaredConstructor().newInstance();
          jdbcURI=jdbcURIHsqldb;
          break;
        case "oracle":
          Class.forName(jdbcDriverOracle).getDeclaredConstructor().newInstance();
          jdbcURI=jdbcURIOracle;          
          break;
        case "H2":
          Class.forName(jdbcDriverH2).getDeclaredConstructor().newInstance();
          jdbcURI=jdbcURIH2;          
          break;  
        default:
